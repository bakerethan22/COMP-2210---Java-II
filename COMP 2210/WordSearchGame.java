...
public interface WordSearchGame {
    ...
    * rules.
    * 
    * @param minWordLength The minimum allowed length (i.e., number of
    ...
    */
   SortedSet<String> getAllScorableWords(int minWordLength);
 ...
 /**
   ...
   * @param minWordLength The minimum number of characters required per word
   * @return the cummulative score of all scorable words in the set
   * @throws IllegalArgumentException if minWordLength < 1
   * @throws IllegalStateException if loadLexicon has not been called.
   */  
   int getScoreForWords(SortedSet<String> words, int minWordLength);
